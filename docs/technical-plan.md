...
| **P2** | 价格明细 + 保险推荐(仍 CLI):tyche `rental_get_order_details` 已含明细;补保险推荐 prompt、用户画像槽位、tyche 不覆盖的保险查询(若需要)走 saas-api inner 兜底 | ~16h | [phase2-price-detail-insurance.md](specs/phase2-price-detail-insurance.md) |
